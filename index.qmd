...
Plot.plot({
  ...
  x: {
    label: "Relevance Degree (Centrality)",
    labelAnchor: "center",
    labelOffset: 25,
    fontSize: "12px"
},
  y: {
    label: "Development Degree (Density)",
    labelAnchor: "center",
    labelRotate: 90,
    labelOffset: 40,
    fontSize: "12px"
...
Visualization of [thematic mapping](https://doi.org/10.1145/2556288.2556969 "Click to learn how to interpret the thematic map"){target="_blank"}, with filtering by department.
:::
