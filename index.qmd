...
@fig-thematic-map-dep visualizes the relationship between centrality (the importance or influence of a theme) and density (the development and cohesion of a theme) across different clusters. The plot divides the space into four key categories. Motor themes (high centrality and high density) are well-developed, important themes that are central to the research field. Basic themes (high centrality but low density) represent widely connected themes that are fundamental but may lack depth or development. Niche themes (low centrality but high density) are highly specialized, well-developed themes that are not central to the main field. Emerging or declining themes (low centrality and low density) indicate topics that are either emerging and developing or losing relevance.
